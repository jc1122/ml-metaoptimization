...
**Orchestrator-owned fields** (set by the orchestrator when persisting, NOT by the worker):
- `proposal_id`: non-empty string, unique within the campaign. Generated by the orchestrator using `<campaign_id>-p<sequence_number>` format.
